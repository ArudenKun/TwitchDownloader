...
namespace TwitchDownloader.Controls.Acrylic;
    ...
    : ICustomDrawOperation
{
    ...
    public void Render(ImmediateDrawingContext context)
    {
        ...
        const double NOISE_OPACITY = 0.0225;
        ...
        if (_acrylicNoiseShader == null)
        {
            ...
            _acrylicNoiseShader = SKShader.CreateBitmap(bitmap, SKShaderTileMode.Repeat, SKShaderTileMode.Repeat).WithColorFilter(CreateAlphaColorFilter(NOISE_OPACITY));
        }
